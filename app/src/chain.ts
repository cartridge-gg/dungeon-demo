 ...
 *  node's durable settled-block checkpoint — a fast local call to the appchain
 *  RPC instead of a `piltover.get_state()` round-trip to the settlement chain.
 *  Returns 0 when nothing has settled yet. */
